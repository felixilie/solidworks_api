...
Sub MainRotorBrazingFixture(UnitType As String, ByRef DimensionsArray As Variant, Optional ByRef errors As Boolean = True)
...
'    End Select
    ...
    ToolAssemblyPath = MainRotorBrazingFixturePath + "Assembly, Tool, Brazing, Coils, Rotor, Main.SLDASM"
