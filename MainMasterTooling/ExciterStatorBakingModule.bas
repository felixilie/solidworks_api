Attribute VB_Name = "ExciterStatorBakingModule"
Option Explicit

Const PI = 3.14159265358979

Sub ExciterStatorBaking()
    ...
    UnitType = "Agusta 169" ' "Agusta 609 DC", "Agusta 169', "Latitude", "Agusta 609 AC"
    ...
    Select Case UnitType
        ...
        Case "Latitude"
            ...
            LamMinID = 4.184 'Min
            CoreHeight = 0.517 'Max
            AboveCoilsHeight = 0.36 'From Model
            AboveInsulationHeight = 0.1 'From Model, give extra
            
            'Give extra .050 in diameter to keep coils out.
    ...
    PlateScrewsR = PlatePinLocationD / 2
    ...
    boolstatus = swModelDocExt.SelectByID2("CirPattern7", "BODYFEATURE", 0, 0, 0, False, 0, Nothing, 0)
    Set swSelectionMgr = swModel.SelectionManager
    Set swFeature = swSelectionMgr.GetSelectedObject6(1, -1)
    Set swCircularPatternFeatureData = swFeature.GetDefinition
    ' Get or sets the number of instances in the circular-pattern feature
