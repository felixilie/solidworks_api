Attribute VB_Name = "ExciterRotorStackingModule"
Option Explicit

Const PI = 3.14159265358979

Sub ExciterRotorStacking()
    ...
    Dim DrainHoleD4 As Double 'DrainHoleD4@MainSketch
    Dim DrainHolePattern4 As Double 'DrainHolePattern4@MainSketch
    Dim DrainHoleAngle4 As Double 'DrainHoleAngle4@MainSketch
    Dim ScrewAngle As Double 'ScrewAngle@MainSketch
    ...
    '***********************************************************************************************************
    UnitType = "A4" ' "Agusta 609 DC", "Agusta 169', "Latitude", "Agusta 609 AC", "SAAB"
    '***********************************************************************************************************
    '***********************************************************************************************************
    ...
    Select Case UnitType
        ...
        Case "CH"
            ...
            LamOD = 4.3  'ActualOD - 2 * Tooth width
            LamID = 0.9
            DivisionPattern = 3 'usually 3 or 6
            LocationPinD = 0.313 'Min Value
            LocationPinPatternD = 1.885
            DrainHoleD1 = 0.188
            DrainHolePattern1 = 3.015
            DrainHoleD2 = 0.16
            DrainHolePattern2 = 3.333
            DrainHoleAngle2 = 8.375
            DrainHoleD3 = 3 / 8
            DrainHolePattern3 = 3.015
            DrainHoleAngle3 = 30
            DrainHoleD4 = 0.188
            DrainHolePattern4 = 3.015
            DrainHoleAngle4 = 60
            ScrewPatternD = 2
            ScrewAngle = 20
            CoreHeight = 0.475 'Mid value
        ...
        Case "A4"
            ...
            LamOD = 4.25  'ActualOD - 2 * Tooth width
            LamID = 1.36
            DivisionPattern = 3 'usually 3 or 6
            LocationPinD = 0.31 'Min Value
            LocationPinPatternD = 1.976
            DrainHoleD1 = 0.343
            DrainHolePattern1 = 2.811
            DrainHoleD2 = 0.166
            DrainHolePattern2 = 3.085
            DrainHoleAngle2 = 13.5
            DrainHoleD3 = 0.5
            DrainHolePattern3 = 2.4
            DrainHoleAngle3 = 180 + 36
            DrainHoleD4 = 0.5
            DrainHolePattern4 = 2.4
            DrainHoleAngle4 = 84
            ScrewPatternD = 2.7
            ScrewAngle = 60 + 180
            CoreHeight = 1.58 'Mid value
...
'    MainSketch
    ...
    swModel.Parameter("DrainHoleD4@MainSketch").SystemValue = DrainHoleD4 * inTOmeter
    swModel.Parameter("DrainHolePattern4@MainSketch").SystemValue = DrainHolePattern4 * inTOmeter
    swModel.Parameter("DrainHoleAngle4@MainSketch").SystemValue = DrainHoleAngle4 * degTORad
    swModel.Parameter("ScrewAngle@MainSketch").SystemValue = ScrewAngle * degTORad
