...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} UserForm 
   ...
   ClientTop       =   450
   ClientWidth     =   11760
   OleObjectBlob   =   "DrawingTool.frx":0000
...
materialsList = Array("ALUMINUM", "4140/4142 ALLOY", "CARBON STEEL", "EPOXY", "WOOD", "Graphit", "GLASS", "GAROLITE", "SEE COMPONENTS")
materialsNoteList = Array("ALUMINUM" & Chr(13) & "PER ASTM B-29 xxxx", "4140/4142 ALLOY", "CARBON STEEL", "EPOXY", "WOOD", "Graphit", "GLASS", "GAROLITE", "SEE COMPONENTS")

unitsList = Array("Cessna", "Agusta 169", "Bell 525", "Boeing CH-47", "Cessna Latitude", "Embraer KC390", "Textron", "Embraer KC390 Inverter", "G7000")
unitsNameList = Array("SGA1-300-2-A", "SGA11-300-2-A", "GNA19-10A-2A", "GNA17-15A-1A", "GNA12-5A-2A", "GNO9-90A-2A", "GNO12-150A-1A", "IN01-10A-1A", "TRU3-300-5A")
...
'Get access to documnet'
    ...
    If PartNameCurrentValue <> PartName Then changeNote PartName, "titleBox@Sheet Format1", 0, 0
    ...
    'Select Case materialBox.Value
    i = FindStringPosition(materialsList, materialBox.Value)
    xxx = materialsNoteList(i)
    changeNote xxx, "materialBox@Sheet Format1", 0, 0
      
    'Adds Unit Note according to value selected "Agusta 169" "Cessna Latitude" "Embraer KC390" "Boeing CH-47" "Textron" "Bell 525"
